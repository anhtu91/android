...
public final class ContactsViewModel_Factory implements Factory<ContactsViewModel> {
  ...
  public ContactsViewModel_Factory(Provider<Context> contextProvider,
      Provider<ContactsRepo> contactsRepoProvider, Provider<Navigator> navigatorProvider) {
  ...
  public ContactsViewModel get() {
    ContactsViewModel instance = newInstance(contextProvider.get(), contactsRepoProvider.get());
  ...
  public static ContactsViewModel_Factory create(Provider<Context> contextProvider,
      Provider<ContactsRepo> contactsRepoProvider, Provider<Navigator> navigatorProvider) {
    return new ContactsViewModel_Factory(contextProvider, contactsRepoProvider, navigatorProvider);
  }

  public static ContactsViewModel newInstance(Context context, ContactsRepo contactsRepo) {
    return new ContactsViewModel(context, contactsRepo);
  }
}
