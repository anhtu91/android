...
@JsonSubTypes (JsonSubTypes.Type(value = MessageStatusAddingNewParking::class, name = MessageStatusAddingNewParking.TYPE), JsonSubTypes.Type(value = MessageReceiveFieldNameAddNewParking::class, name = MessageReceiveFieldNameAddNewParking.TYPE), JsonSubTypes.Type(value = MessageReceiveKeyIDAddNewParking::class, name = MessageReceiveKeyIDAddNewParking.TYPE), JsonSubTypes.Type(value = MessageStatusDeleteParkingSpot::class, name = MessageStatusDeleteParkingSpot.TYPE), JsonSubTypes.Type(value = MessageReceiveSelectedParking::class, name = MessageReceiveSelectedParking.TYPE), JsonSubTypes.Type(value = MessageInviteSuccess::class, name = MessageInviteSuccess.TYPE), JsonSubTypes.Type(value = MessageReceiveFieldNameInvite::class, name = MessageReceiveFieldNameInvite.TYPE), JsonSubTypes.Type(value = MessageReceiveKeyIDInvite::class, name = MessageReceiveKeyIDInvite.TYPE), JsonSubTypes.Type(value = MessageWaypointToEntrance::class, name = MessageWaypointToEntrance.TYPE), JsonSubTypes.Type(value = MessageRecommendParkingSpot::class, name = MessageRecommendParkingSpot.TYPE), JsonSubTypes.Type(value = MessageUserInParkingSpot::class, name = MessageUserInParkingSpot.TYPE), JsonSubTypes.Type(value = MessageLocation::class, name = MessageLocation.TYPE), JsonSubTypes.Type(value = MessageTransition::class, name = MessageTransition.TYPE), JsonSubTypes.Type(value = MessageCard::class, name = MessageCard.TYPE), JsonSubTypes.Type(value = MessageCmd::class, name = MessageCmd.TYPE), JsonSubTypes.Type(value = MessageConfiguration::class, name = MessageConfiguration.TYPE), JsonSubTypes.Type(value = MessageEncrypted::class, name = MessageEncrypted.TYPE), JsonSubTypes.Type(value = MessageWaypoint::class, name = MessageWaypoint.TYPE), JsonSubTypes.Type(value = MessageWaypoints::class, name = MessageWaypoints.TYPE), JsonSubTypes.Type(value = MessageLwt::class, name = MessageLwt.TYPE))
