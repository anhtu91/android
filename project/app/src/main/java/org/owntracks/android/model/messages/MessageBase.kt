...
@JsonSubTypes (JsonSubTypes.Type(value = MessageReceiveKeyID::class, name = MessageReceiveKeyID.TYPE), JsonSubTypes.Type(value = MessageWaypointToEntrance::class, name = MessageWaypointToEntrance.TYPE), JsonSubTypes.Type(value = MessageEmpfehlungParkplatz::class, name = MessageEmpfehlungParkplatz.TYPE), JsonSubTypes.Type(value = MessageParkplatz::class, name = MessageParkplatz.TYPE), JsonSubTypes.Type(value = MessageLocation::class, name = MessageLocation.TYPE), JsonSubTypes.Type(value = MessageTransition::class, name = MessageTransition.TYPE), JsonSubTypes.Type(value = MessageCard::class, name = MessageCard.TYPE), JsonSubTypes.Type(value = MessageCmd::class, name = MessageCmd.TYPE), JsonSubTypes.Type(value = MessageConfiguration::class, name = MessageConfiguration.TYPE), JsonSubTypes.Type(value = MessageEncrypted::class, name = MessageEncrypted.TYPE), JsonSubTypes.Type(value = MessageWaypoint::class, name = MessageWaypoint.TYPE), JsonSubTypes.Type(value = MessageWaypoints::class, name = MessageWaypoints.TYPE), JsonSubTypes.Type(value = MessageLwt::class, name = MessageLwt.TYPE))
